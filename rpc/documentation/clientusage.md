...
var certificateFile = filepath.Join(dcrutil.AppDataDir("fistwallet", false), "rpc.cert")
...
namespace Example
{
    static class Program
    {
        ...
        static async Task ExampleAsync()
        {
            ...
            var walletAppData = Portability.LocalAppData(Environment.OSVersion.Platform, "fistwallet");
...
def main():
    ...
    if platform.system() == 'Windows':
        cert_file_path = os.path.join(os.environ['LOCALAPPDATA'], "fistwallet", "rpc.cert")
