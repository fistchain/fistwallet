...
const (
	...
	defaultConfigFilename      = "fistwallet.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "fistwallet.log"
...
var (
	dcrdDefaultCAFile  = filepath.Join(dcrutil.AppDataDir("fistd", false), "rpc.cert")
	defaultAppDataDir  = dcrutil.AppDataDir("fistwallet", false)
